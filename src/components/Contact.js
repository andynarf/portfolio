...
export default function Contact() {
  return (
    <Container className="contact-container">
      <h2>
        {" "}
        <a id="Contact" href="#Contact" className="section-title touch">
          Get In Touch{" "}
        </a>
      </h2>
      <p className="contact-text">
        To get in touch with me, you can send me an email, or contact me via
        GitHub or LinkedIn.
      </p>

      <h3 className="mail-container">
        <FontAwesomeIcon className="icon" icon={"envelope"} />
        <a className="myemail" href="mailto:andresrodriguez4@outlook.com.ar">
          andresrodriguez4@outlook.com.ar
        </a>
      </h3>
